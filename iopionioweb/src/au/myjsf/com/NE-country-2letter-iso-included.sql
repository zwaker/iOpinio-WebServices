...
INSERT INTO `countries` (`code`, `continent_code`, `name`, `iso3`, `number`, `full_name`) VALUES
  ...
  ('GB', 'EU', "United Kingdom", 'GBR', '826', "United Kingdom of Great Britain & Northern Ireland"),
  ('US', 'NA', "United States", 'US', '840', "United States"),
  ...
  DELETE FROM COUNTRIES WHERE CODE='GB'
   INSERT INTO `countries` (`code`, `continent_code`, `name`, `iso3`, `number`, `full_name`) VALUES
  ('GB', 'EU', "United Kingdom", 'GBR', '826', "United Kingdom of Great Britain & Northern Ireland");
 
  DELETE FROM COUNTRIES WHERE CODE='US'
  INSERT INTO `countries` (`code`, `continent_code`, `name`, `iso3`, `number`, `full_name`) VALUES
  ('US', 'NA', "United States", 'USA', '840', "United States");
